...
def plot_ridership_vs_precipitation(merged_data):
    try:
        ...
        ax1.set_ylim(100000, 300000)  # Y축 최소값을 100,000으로 설정하고 최대값을 300,000으로 설정

        ax1.set_title('하루 승차 + 하차 총 승객수와 강수량 비교 (24년 4월)')
        ...
        # 강수량 y축 범위 설정
        ax2.set_ylim(0, 50)  # 강수량 y축의 범위를 0 ~ 50으로 설정
...
if __name__ == "__main__":
    # 강수량 데이터 파일 경로 (예시)
    precipitation_file = 'precipitation_202404.csv'  # 실제 경로를 넣어야 합니다.
    subway_file = 'subway_202404.csv'  # 실제 경로를 넣어야 합니다.
